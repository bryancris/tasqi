    ...
    <div className="w-full max-w-5xl mx-auto bg-white p-6 rounded-lg">
      ...
      <CalendarComponent 
        ...
        classNames={{
          ...
          cell: "relative p-0 text-center focus-within:relative focus-within:z-20 [&:has([aria-selected])]:bg-accent first:[&:has([aria-selected])]:rounded-l-md last:[&:has([aria-selected])]:rounded-r-md",
          day: "h-24 w-full p-0 font-normal aria-selected:opacity-100 hover:bg-gray-50 border-t border-l first:border-l-0 [&:nth-child(7n)]:border-r",
