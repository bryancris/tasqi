...
export function ToolsSection() {
  ...
  return (
    <div className="space-y-2">
      <Button 
        variant="ghost" 
        className="w-full justify-start text-base text-[#9333EA] hover:bg-[#E5E7EB]"
      ...
      <Button 
        variant="ghost" 
        className="w-full justify-start text-base text-[#6B7280] hover:bg-[#E5E7EB]"
      ...
      <Button 
        variant="ghost" 
        className="w-full justify-start text-base text-[#EA580C] hover:bg-[#E5E7EB]"
